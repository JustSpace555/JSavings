 ...
 * @param category Category of wallet
 * @param creditLimit Credit limit for wallet (valid if wallet type is [WalletCategoryType.CREDIT_CARD])
 * @param interestRate Interest rate of wallet (valid if wallet type is [WalletCategoryType.CREDIT_CARD])
 * @param paymentDay Day of payment for wallet (valid if wallet type is [WalletCategoryType.CREDIT_CARD])
 * @param gracePeriod Grace period of wallet (valid if wallet type is [WalletCategoryType.CREDIT_CARD])
...
data class Wallet (
	...
	val balance: Double,
	val currency: String,
	val category: WalletCategoryType,
